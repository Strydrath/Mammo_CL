...
def get_datasets(path_to_data, train_ratio=0.8, batch_size=32, random_seed=42):
    ...
    train_set, test_set, val_set = random_split(dataset, [num_train, num_test, num_val], generator=torch.Generator().manual_seed(random_seed))
